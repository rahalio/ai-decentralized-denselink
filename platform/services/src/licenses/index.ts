/**
 * Licenses Services - Application Layer Export
 *
...
/**
 * Licenses Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for licenses domain.
 */
